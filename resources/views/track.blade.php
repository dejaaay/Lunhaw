...
<html lang="en">
  <head>
    ...
    <title>Track Your Impact - Lunhaw</title>
  ...
  <body class="font-sans bg-neutral-50 text-neutral-900">
    ...
    <main class="container mx-auto px-4 py-16">
      <div class="max-w-3xl mx-auto text-center">
        <h1 class="text-4xl font-bold">Track Your Impact</h1>
        <p class="mt-3 text-neutral-700">See planted trees, CO₂ offsets, and verified reports over time.</p>
      </div>
    </main>
  </body>
</html>
