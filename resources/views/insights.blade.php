  ...
  <body class="font-sans bg-neutral-50 text-neutral-900">
    ...
    <main class="container mx-auto px-4 py-16">
      <div class="max-w-3xl mx-auto text-center">
        <h1 class="text-4xl font-bold">Real-time Insights</h1>
        <p class="mt-3 text-neutral-700">Monitor planting progress, survival rates, and carbon offsets in real time.</p>
      </div>
    </main>
  </body>
</html>
