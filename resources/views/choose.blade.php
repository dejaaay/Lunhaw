...
<html lang="en">
  <head>
    ...
    <title>Choose a Tree - Lunhaw</title>
  ...
  <body class="font-sans bg-neutral-50 text-neutral-900">
    ...
    <main class="container mx-auto px-4 py-16">
      <div class="max-w-3xl mx-auto text-center">
        <h1 class="text-4xl font-bold">Choose a Tree</h1>
        <p class="mt-3 text-neutral-700">Browse reforestation projects and pick the species and location that align with your goals.</p>
      </div>
    </main>
  </body>
</html>
